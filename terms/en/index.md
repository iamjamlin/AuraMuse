...
- Unlocking member-only white noise, music, affirmations, and other content
- Supporting preparation, caching, and playback of member audio resources
- Supporting other membership benefits that may be clearly marked in the app in the future

The specific membership benefits, applicable scope, display method, and availability are subject to the information shown in the app when you use it.
...
## 3. Paid Content and Membership Benefits
...
- Circumvent subscriptions, verification, caching, or access restrictions by technical means
- Reverse engineer, decompile, crack, or otherwise unlawfully process the app, audio resources, or related mechanisms

### 3. Local Content You Import

If you use the custom audio or custom background features, you are responsible for ensuring that any audio, image, or video you import comes from a lawful source and that you have the necessary rights or permissions to use it.
...
- You actively clearing the cache in the app
- You deleting the app or changing devices
...
If you violate these Terms or applicable laws and regulations, we may, within a reasonable scope, restrict, suspend, or terminate the relevant services provided to you, and we reserve the right to pursue legal liability where appropriate.

## 5. Subscription Fees and Payment

### 1. Billing Method

After you confirm a purchase, the fee will be charged to your Apple ID or Apple account, and Apple will complete the payment process in accordance with its payment rules.
...
If you wish to cancel auto-renewal, you must manually turn it off at least 24 hours before the end of the current subscription period. You can manage your subscription status in iOS Settings > Apple ID > Subscriptions.

### 4. Renewal Failure

If renewal fails due to insufficient balance, payment restrictions, or reasons related to the Apple platform, the membership service may be suspended or downgraded after the current subscription period ends. The actual benefits available will be subject to the status shown by Apple and within the app.

### 5. Free Trials, Promotions, and Price Changes

If free trials, promotional offers, or price changes are displayed in the app or on the App Store page, the applicable conditions, effective method, cancellation rules, and final price are subject to the actual information displayed by the App Store and Apple's rules.

## 6. Purchase Restoration and Membership Status Synchronization

If you have previously purchased a valid membership service using the same Apple ID, you may use the in-app Restore Purchases feature to synchronize your membership status again.

The result of purchase restoration depends on the valid transaction records and current subscription status returned by Apple. If no valid membership record is found, membership benefits may not be restored.
...
- Adjusting the subscription page, purchase process, or benefit descriptions
- Temporary unavailability of certain features due to system maintenance, network issues, platform policy changes, or similar reasons

We will make reasonable efforts to maintain the continuity and stability of the services. However, to the extent permitted by law, we are not liable for service interruptions caused by network conditions, device status, Apple platform service issues, system version differences, force majeure, or other circumstances beyond our reasonable control.
...
If you have any questions about these Terms, membership subscriptions, renewal rules, or related benefits, you may contact us through the contact information provided in the app.
